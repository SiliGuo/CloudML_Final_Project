...
UPLOAD_FOLDER = '/logs/'
#UPLOAD_FOLDER = '/Users/siliguo/Desktop/NYU/2020 Fall/CSCI-GA 3033-085/Project/CloudML_image_captioning_aplication/'
...
def get_result(filename):
    ...
    model.load_weights('model_65.h5')

    image_model = get_image_feature_model()

    photo_feature = extract_features(filepath, image_model, inpute_size = (229,229)).reshape(1, 2048)
    caption = generate_desc(max_length, model, photo_feature, inference=True)
    return caption
